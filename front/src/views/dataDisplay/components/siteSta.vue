...
<template>
  <div class="data-s-l">
    <chart-head>
      ...
      <div slot="head-r">
        <a-select v-model="siteYear" class="component-w-108" @change="handleChange">
    ...
    <div id="barChart" style="width: 100%; height: 85%; margin-top: 10px"></div>
  </div>
</template>
<script>
